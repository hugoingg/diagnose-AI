...
diabetes_model_path = os.path.join(current_dir, 'saved models', 'diabetes_model.sav')
heart_model_path = os.path.join(current_dir, '..', 'saved models', 'heart_model.sav')
parkinsons_model_path = os.path.join(current_dir, '..', 'saved models', 'parkinsons_model.sav')
